<script>
    ...
    let steps = [
        {
            name: "Python GUI Downloader",
            icon: "fa-solid fa-download",
            description: "Project 1 description",
            href: "https://github.com/Aman1337g/python-gui-downloader",
        },
        {
            name: "Django ChatGPT Chatbot",
...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Aman</span>
                Gupta<br />Full Stack
            ...
            <a
                class="blueShadow mx-auto lg:mr-auto lg:ml-auto text-base sm:text-lg md:text-xl poppins relative overflow-hidden px-6 py-3 group rounded-full bg-white text-slate-950 cursor-pointer"
                href="https://www.linkedin.com/in/aman-gupta-b03906227/"
                target="_blank"
            >
                <div
        ...
        <div class="relative shadow-2xl grid place-items-center">
            <img
                src={"./images/profile-wo-bg-circle.png"}
                alt="Profile image"
    ...
    <section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>
                    User-friendly application for effortlessly downloading
                    files. The project relies on essential dependencies,
                    including <strong class="text-violet-400"
                        >tkinter, requests, threading, os, shutil, tqdm, and
                        ttkthemes</strong
                    >.
                </p>
            </Step>
            <Step step={steps[1]}>
                <p>
                    Real-time conversations with a GPT-3.5 powered Chatbot
                    seamlessly integrated into Django web applications. Tools
                    used include <strong class="text-violet-400"
                        >Django and OpenAI GPT-3.5
                    </strong>, providing a robust and flexible chatbot
                    experience.
                </p>
            </Step>
            <!-- <Step step={steps[2]}>
